                ...
                <tr v-for="user in users" :key="user.id">
                    ...
                    <td class="text-center [&>*]:mx-1">
                        <div class="tooltip" data-tip="Opens User window">
                            <RouterLink :to="{ name: 'dashboard.users.show', params: { id: user.id } }" class="btn btn-info">
                                View
                            </RouterLink>
                        </div>
                        <div class="tooltip" data-tip="Opens update window">
                            <button @click="updateUser(user.id)" class="btn btn-warning">Update</button>
                        </div>
                        <div class="tooltip" data-tip="Opens deletion confirm window">
                            <button @click="deleteUser(user.id)" class="btn btn-error">Delete</button>
                        </div>
                    </td>
                    <td>
                    ...
                    <!-- <td>
                        <button class="btn" @click="'my_modal_' + user.id.showModal()">open modal</button>
    ...
    export default {
        ...
        methods: {
            ...
            retrieveUsers() {
                ...
                axios.get(apiUrl + '/users?limit=10&offset=' + (this.limit - 10))
                    .then(response => {
                        console.log(response.data);
