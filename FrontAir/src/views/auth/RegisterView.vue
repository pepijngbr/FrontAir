<template>
    ...
    <label class='form-control'>
        ...
        <input v-model='this.email' type='text' placeholder='daisy@gmail.com' class='input input-bordered w-full max-w-xs' />
    </label>
    <label class='form-control'>
        <div class='label'>
            <span class='label-text'>Create a password</span>
        </div>
        <input v-model='this.password' type='password' placeholder='Enter your password' class='input input-bordered w-full max-w-xs' />
    </label>
    ...
    <p>
        ...
        <RouterLink to='/reset-password' class='text-secondary font-bold'>Reset Password</RouterLink>
    </p>
</template>
