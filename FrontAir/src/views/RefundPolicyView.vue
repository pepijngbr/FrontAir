    ...
    <div class="container mx-auto max-w-[800px] px-4 py-20">
        ...
        <div class="rounded-lg bg-white p-8 shadow-lg">
            <p class="text-gray-700">
                ...
                to help. Our refund policy lasts 30 days. If 30 days have gone
                by since your purchase, unfortunately we can’t offer you a
                refund or exchange.
            </p>
        </div>
    </div>
            ...
            meta: [
                {
                    name: 'description',
                    content:
                        'The refund policy page of FrontAir, a flight booking web application. Welcome to FrontAir, your one-stop destination for booking flights at the best prices. Find deals on international and domestic flights, compare airlines, and plan your perfect trip.',
                },
                {
                    name: 'keywords',
                    content:
                        'refund, refund policy, policy, flights, flight booking, cheap flights, airline tickets, travel, FrontAir, flight deals, international flights, domestic flights',
                },
                {
                    name: 'author',
                    content: 'FrontAir',
                ...
                {
                    property: 'og:title',
                    content: 'Refund Policy - FrontAir',
                },
                {
